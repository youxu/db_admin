...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
  	...
  	<td width="200px" height="100%" valign="top" id="FrameTitle" background="/admin_style/images/left_bg.gif">
  		<?php include_once 'left.php'; ?>
	</td>

    <td>

   	  <iframe id="MainIframe" name="MainIframe" scrolling="yes" src="<?php echo site_url()?>/project" width="100%" height="100%" frameborder="0" noresize> </iframe>
