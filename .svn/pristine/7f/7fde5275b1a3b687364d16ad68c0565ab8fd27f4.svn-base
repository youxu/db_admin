			...
			success :function (data){
				...
				$.each(data, function(i,n){
						$.each(n.userList, function(k,v){
							...
							html += '<td>'+sts+'</td>';
							html += '<td>';
							html += '<a href="/index.php/user/update_user/'+v.id+'">编辑</a>&nbsp;';
							html += '<a href="/index.php/user/update_user/user_project/'+v.id+'">分配项目</a>&nbsp;';
