...
var url="/index.php/ma_group/index";
			...
			success :function (data){
				...
				$.each(data, function(i,n){
						$.each(n.userList, function(k,v){
							...
							html += '<td>'+sts+'</td>';
							html += '<td>';
							html += '<a href="/index.php/ma_group/update_ma_group/'+v.id+'">编辑</a>&nbsp;';
							html += '<a href="#" onclick="del_ma_group(\''+v.id+'\',\''+v.name+'\',this)">删除</a>';
							html += '</td>';
							html += '</tr>';
						});
						$("#pager").html(n.pager);
...
function del_ma_group(name,project_id,va){
    ...
    if (v == true)
    {
    	if(project_id == ''){
			...
			$.ajax({
				url :'/index.php/ma_group/del_ma_group',
				type : 'POST',
				data:{
					id:project_id,
				},
